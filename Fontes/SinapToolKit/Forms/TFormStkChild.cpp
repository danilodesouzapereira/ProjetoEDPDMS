	...
	: TForm(Owner)
{
	...
	//cria menu STK: Enerq
	FrameEDPDMS = new TFrameEDPDMS(this, apl);
	sinap_child->FormStkAdd("STK: Enerq", FrameEDPDMS->ActionList, expand);
}
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
void __fastcall TFormStkChild::ActionOcorrenciaExecute(TObject *Sender)
{
	TForm *Form;
	VTMultiPanel *MultiPanel = (VTMultiPanel*)apl->GetObject(__classid(VTMultiPanel));
	Form = DLL_NewFormExtratorDados(this, apl, MultiPanel->PanelAtivo);
...
//---------------------------------------------------------------------------
void __fastcall TFormStkChild::ActionCalcIndicesContinuidadeExecute(TObject *Sender)
{
	TForm *Form;
	VTMultiPanel *MultiPanel = (VTMultiPanel*)apl->GetObject(__classid(VTMultiPanel));
	Form = DLL_NewFormCalcIndCont(this, apl, MultiPanel->PanelAtivo);
...
void __fastcall TFormStkChild::ActionCalcIndContExecute(TObject *Sender)
{
	TForm *Form;
	VTMultiPanel *MultiPanel = (VTMultiPanel*)apl->GetObject(__classid(VTMultiPanel));
	Form = DLL_NewFormCalcIndCont(this, apl, MultiPanel->PanelAtivo);
